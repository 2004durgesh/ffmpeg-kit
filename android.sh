...
# EXPORT BUILD TOOL LOCATIONS FROM ROOT SDK FOLDER
# Check if running in Docker (Android SDK will be mounted at /opt/android-sdk)
if [ -d "/opt/android-sdk" ]; then
  export ANDROID_SDK_ROOT="/opt/android-sdk"
  export ANDROID_NDK_ROOT="/opt/android-sdk/ndk/27.1.12297006"
else
  # Fallback to Windows paths for direct execution
  export ANDROID_SDK_ROOT="C:/Users/Durgesh/AppData/Local/Android/Sdk"
  export ANDROID_NDK_ROOT="C:/Users/Durgesh/AppData/Local/Android/Sdk/ndk/27.1.12297006"
fi

# CHECK IF SDK AND NDK EXIST
if [[ ! -d ${ANDROID_SDK_ROOT} ]]; then
  echo -e "\n(*) ANDROID_SDK_ROOT not found at ${ANDROID_SDK_ROOT}\n"
  echo -e "(*) Please ensure sdk/android-sdk-linux directory exists in the project root\n"
  exit 1
fi

if [[ ! -d ${ANDROID_NDK_ROOT} ]]; then
  echo -e "\n(*) ANDROID_NDK_ROOT not found at ${ANDROID_NDK_ROOT}\n"
  echo -e "(*) Please ensure sdk/android-ndk-r27c directory exists in the project root\n"
  exit 1
fi
